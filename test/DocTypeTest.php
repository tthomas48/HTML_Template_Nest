 ...
 */
class HTML_Template_Nest_DocTypeTest extends PHPUnit_Framework_TestCase
{
    /**
     * Tests that a doctype is preserved
     * 
     * @return unknown_type
     */   
    public function testDocType()
    {
        ...
        $view = new HTML_Template_Nest_View("doctype");
        $view->addAttribute("outval", "Output Me!");
        $filename = dirname(__FILE__) . "/viewoutput/doctype.html";
        $this->assertEquals(
            $view->render(), 
